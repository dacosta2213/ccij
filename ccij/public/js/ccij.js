...
frappe.templates["ccij"] = '<aside class="main-sidebar">'
 ...
 +'            <li><a href="#List/Proyecto/Kanban/Por%20Estado"><i class="fa fa-cog"></i>  Proyectos</a></li>'
 ...
 +'            <li><a href="#List/Sales Invoice"><i class="far fa-money-bill-alt"></i>  Servicios</a></li>'
 +'            <li><a href="#List/Customer"><i class="octicon octicon-organization"></i>  Organismos</a></li>'
